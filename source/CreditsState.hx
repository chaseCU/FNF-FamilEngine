...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var pisspoop = [ //Name - Icon name - Description - Link - BG Color
			['Famil Engine Team'],
			['Family1242 (Famil)',		'family1242',		'Main Programmer and artist of Famil Engine',		'https://github.com/family1242',	'0xFFFF6633'],
			['4wdthinking',		'thinking',		'Helped me with some code because I have a very small brain',		'https://www.youtube.com/channel/UCCvPvv-T6bWQOGoYhcFbpYA',	'0xFF0A0812'],
			[''],
			['Famil Engine Contributors'],
			['TentaRJ', 	'tentarj', 		'GameJolt Integration Support for FNF',		'https://github.com/TentaRJ',		'0xFF61406F'],
			[''],
			['Psych Engine Team'],
