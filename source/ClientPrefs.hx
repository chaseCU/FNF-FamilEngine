...
class ClientPrefs {
	...
	public static var feWatermarks:Bool = true; //Famil Engine Watermarks
	public static var instantRespawn:Bool = false;
	public static var hitSounds:Bool = false;
	public static var mainMenuDetails:Bool = true;
	...
	public static function saveSettings() {
		...
		FlxG.save.data.feWatermarks = feWatermarks;
		FlxG.save.data.instantRespawn = instantRespawn;
		FlxG.save.data.hitSounds = hitSounds;
		FlxG.save.data.mainMenuDetails = mainMenuDetails;
	...
	public static function loadPrefs() {
		...
		if(FlxG.save.data.feWatermarks != null) {
			feWatermarks = FlxG.save.data.feWatermarks;
		}
		...
		if(FlxG.save.data.mainMenuDetails != null) {
			mainMenuDetails = FlxG.save.data.mainMenuDetails;
		}
